...
enum FlitType { HEADER, BODY, TAIL };
...
struct Flit {
    ...
    // --- NUEVO: Soporte Multicast ---
    bool is_multicast;
    std::vector<int> dest_routers;
    std::vector<int> dest_neurons;
    std::vector<double> payload_weights;
    ...
    payload_weight(0.0), dest_neuron_id(-1), is_multicast(false) {}
